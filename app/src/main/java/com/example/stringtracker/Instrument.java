...
//////////////////////// DB //////////////////////////////////
 ...
 //       dbHelper.close();
    ...
    public boolean insertInstr(Context context) throws SQLException {   //Rating???
        ...
        StringTrackerDBHelper dbHelper = new StringTrackerDBHelper(context);
        ...
        try {
            ...
            initialValues.put("InstrumentID", InstrID);
    ...
    public boolean loadInstr(int InsID, Context context) throws SQLException {   //Rating???
        ...
        System.out.println("*** Start DB LOAD");

        try {

            ///
            ///     TODO-MODIFY THIS CODE TO QUERY DB FOR RECORD
            ///
            ContentValues initialValues = new ContentValues();
            //setContext(this);
            database = dbHelper.getWritableDatabase();
